...
//       <div className="container-fluid newfooter-section">
...
//                 <li>
//                   {" "}
//                   <Link href="/PagePackage" className="text-white">
//                     Packages
//                   </Link>
//                 </li>
...
//                   className="text-decoration-none flex gap-3 text-white"
//                 >
//                   <span>
//                     <PhoneCall />
//                   </span>{" "}
...
//                 </a>
//               </div>
//               <div className="footer-contact-details flex gap-3 text-white">
//                 <span>
//                   <MapPin />
//                 </span>{" "}
...
//             <div className="col-lg-3 col-md-6 footer-social text-white">
        ...
        <div className="container">
          ...
          <div className="flex justify-center flex-wrap">
            <div className="footer-main flex justify-center gap-20">
              ...
              <div className="footer-vertical-line newfooter-vr-line"></div>
              <div className="footer-links">
                <ul>
                  <li>
                    <Link href="/" className="text-white">
          ...
          <div className="footer-social flex  justify-center items-center gap-4 my-5">
            <div className="footer-horizontal-line new-footer-hr-line"></div>
            <div className="footer-followus flex flex-col justify-center items-center text-white">
              <h1>Follow Us On:</h1>
